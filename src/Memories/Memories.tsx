...
const chibupelyaMemories = [
  {
    id: 'chibupelya1',
    phrase: '. . . как гуляли до утра и я замерзла, а ты обнимал меня чтобы мне было теплей и накрывал меня своей кофтой',
  },
  {
    id: 'chibupelya2',
    phrase: '. . . как ты встречал меня с Черкасс с цветочками и осьминожкой',
  },
  {
    id: 'chibupelya3',
